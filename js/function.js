(function ($) {
  ...
  if ($(".company-supports-slider-prime").length) {
    const company_supports_slider_prime = new Swiper(
      ".company-supports-slider-prime .swiper",
      {
        slidesPerView: 2,
        speed: 2000,
        spaceBetween: 30,
  ...
  if ($(".company-supports-slider-metal").length) {
    const company_supports_slider_metal = new Swiper(
      ".company-supports-slider-metal .swiper",
      {
        slidesPerView: 2,
        speed: 2000,
        spaceBetween: 30,
  ...
  if ($service_item_list_prime.length) {
    var $service_item_prime = $service_item_list_prime.find(
      ".service-item-prime"
    );
