    ...
    <div class="container">
        ...
        <div class="row g-3 wow fadeInUp" data-wow-delay="0.2s" style="margin-top:20px;">
            ...
            <div class="col-lg-2 col-md-3 col-4">
                <div style="border:1px solid #e5e5e5; border-radius:8px; background:#fff; aspect-ratio:1/1; display:flex; align-items:center; justify-content:center; padding:12px; transition:box-shadow 0.3s, border-color 0.3s;"
