        ...
        <div class="container">
                ...
                <div class="col-xl-8">
                    ...
                    <div class="project-description wow fadeInUp" style="margin-bottom: 2rem;">
                        <div class="section-title">
                            <span class="section-sub-title">About This Property</span>
            ...
            <div class="row mt-5">
                <div class="col-lg-12 mb-4">
                    <div class="section-title">
                        <span class="section-sub-title wow fadeInUp">More Properties</span>
                        <h2 class="text-anime-style-2" data-cursor="-opaque">Related <span>{{ $property->type_label }}</span> Properties</h2>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                    <div class="project-item wow fadeInUp">
                        <div class="project-item-image">
                            <a href="{{ route('properties.show', $rel->slug) }}" data-cursor-text="View">
                                <figure>
                        ...
                        <div class="project-item-content">
                            ...
                            <h2><a href="{{ route('properties.show', $rel->slug) }}">{{ $rel->title }}</a></h2>
                        </div>
                    </div>
                </div>
                @endforeach
