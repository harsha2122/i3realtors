                ...
                <form action="{{ route('admin.achievements.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                               value="{{ old('title') }}" placeholder="e.g. OREE REALITY" required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">PNG recommended. Max 4MB.</div>
                        @error('image')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        <img id="imgPreview" src="" alt="" style="display:none;margin-top:8px;max-height:100px;border-radius:6px;">
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="units" class="form-control" value="{{ old('units') }}" placeholder="e.g. 107">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Sales Value</label>
                            <input type="text" name="sales_value" class="form-control" value="{{ old('sales_value') }}" placeholder="e.g. 100 Cr.">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Sold %</label>
                            <input type="text" name="sold_percentage" class="form-control" value="{{ old('sold_percentage') }}" placeholder="e.g. 98%">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Time Period</label>
                            <input type="text" name="time_period" class="form-control" value="{{ old('time_period') }}" placeholder="e.g. 3 Months">
                        </div>
                        <div class="col-md-12">
                            <label class="form-label">Location</label>
                            <input type="text" name="location" class="form-control" value="{{ old('location') }}" placeholder="e.g. Bavdhan (PMC)">
                        </div>
                    </div>
