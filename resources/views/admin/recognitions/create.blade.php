...
@section('page-title', 'Add Recognition')
@section('breadcrumb')
    ...
    <div class="col-lg-7">
        <div class="card border-0 shadow-sm rounded-3">
            <div class="card-header bg-white border-0 pt-4 pb-3">
                <h6 class="fw-bold mb-0"><i class="fas fa-plus me-2" style="color:var(--primary)"></i>New Recognition / Association</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.recognitions.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
