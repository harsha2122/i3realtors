...
@section('title', 'Career Form Submissions')
@section('page-title', 'Career Form Submissions')
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
    <li class="breadcrumb-item active">Career Submissions</li>
@endsection

@section('content')
<div class="card border-0 shadow-sm rounded-3">
    <div class="card-header bg-white border-0 pt-4 pb-3 d-flex justify-content-between align-items-center">
        <h6 class="fw-bold mb-0"><i class="fas fa-briefcase me-2" style="color:var(--primary)"></i>Career Form Submissions</h6>
        @if($form)
        <div class="d-flex gap-2">
            <a href="{{ route('career-submissions.export') }}" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="card-body p-0">
        @if(!$form)
            <div class="text-center text-muted py-5">
                ...
                <p>{{ $message ?? 'Career form not configured.' }}</p>
            </div>
