                ...
                <form method="POST" action="{{ route('admin.settings.update') }}" enctype="multipart/form-data" id="settingsForm">
                    ...
                    @else
                        ...
                        @php
                            ...
                            $imageKeys     = ['logo', 'logo_white', 'favicon', 'about_main_image', 'about_item_image_1', 'about_item_image_2', 'breadcrumb_bg', 'about_who_main_image', 'about_who_box1_image', 'about_who_box2_image', 'about_approach_image_1', 'about_approach_image_2', 'about_journey_image_1', 'about_journey_image_2', 'about_journey_image_3', 'about_journey_image_4'];
